...
#file: logger_util.py
#@author: zhiDongMei
#@contact: zhidongmei@gs-robot.com
#@time: 2021/6/3 10:59 下午
#@desc:
import logging
import time
from config.RunConfig import get_project_path,get_yaml_config
...
class LoggerUtil:
	...
	def __init__(self, loggerName=None):
		...
		# 设置日志文件的输入路径和名称
		self.log_path = get_project_path() + '/output/log/'
